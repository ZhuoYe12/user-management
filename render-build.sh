...
./node_modules/.bin/ng build angular-signup-verification-boilerplate --configuration production --base-href / --aot --optimization=true --vendor-chunk=true --build-optimizer=true 